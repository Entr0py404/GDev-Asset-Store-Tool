Public Class PackageMaker
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        If TextBox_PackageName.Text.Length > 0 And TextBox_Tag.Text.Length > 0 And PixelBox_PackageThumbnail.Image IsNot Nothing Then
            SaveFileDialog1.FileName = "PACK.json"
            ...
            If SaveFileDialog1.ShowDialog = DialogResult.OK Then
                ...
                If aspectRatio_IsAlready_16_9 = False Then
                    ...
                    Using g As Graphics = Graphics.FromImage(bmp)
                        ...
                        bmp.Save(Path.GetDirectoryName(SaveFileDialog1.FileName) & "\thumbnail.png", Imaging.ImageFormat.Png)
                    End Using
                Else
                    PixelBox_PackageThumbnail.Image.Save(Path.GetDirectoryName(SaveFileDialog1.FileName) & "\thumbnail.png", Imaging.ImageFormat.Png)
                End If

                My.Computer.FileSystem.WriteAllText(SaveFileDialog1.FileName, sb.ToString, False)

                    Console.WriteLine(Path.GetDirectoryName(SaveFileDialog1.FileName) & "\thumbnail.png")
    ...
    Private Sub TextBox_NewTag_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox_PackageName.KeyPress
    ...
    Private Sub PackageMaker_DragDrop(sender As Object, e As DragEventArgs) Handles Me.DragDrop
        ...
        If files.Length <> 0 Then
            Try
                ...
                PixelBox_PackageThumbnail.Image = Image.FromFile(files(0)) 'GetMemoryBitmapFromFile(files(0))
